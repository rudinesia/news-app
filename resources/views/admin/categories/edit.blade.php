...
<div class="max-w-2xl">
    <div class="card">
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" x-data="categoryForm()">
            @csrf
            @method('PUT')
...
function categoryForm() {
    return {
        ...
        generateSlug() {
            ...
            if (!this.slug || this.slug === this.originalSlug || this.slug === this.slugify(this.previousName)) {
